...
SHORTCUTS = [
    {"label": "Open Cashier",   "type": "Page",     "link_to": "alphax-cashier",           "color": "Pink"},
    {"label": "Process Flow",   "type": "Page",     "link_to": "alphax-pos-flow",          "color": "Blue"},
...
CARDS = [
    {
        ...
        "icon":  "retail",
        "links": [
            {"label": "Cashier (POS Screen)", "link_type": "Page",   "link_to": "alphax-cashier"},
            {"label": "Process Flow",         "link_type": "Page",   "link_to": "alphax-pos-flow"},
            {"label": "Held Orders",         "link_type": "DocType", "link_to": "AlphaX POS Order", "filters": {"docstatus": 0}},
            {"label": "Floor Plan",          "link_type": "Page",    "link_to": "alphax-floor-designer"},
            {"label": "Kitchen Display",     "link_type": "Page",    "link_to": "alphax-kds"},
    ...
    },
    {
        ...
        "links": [
            ...
            {"label": "Setup Wizard",        "link_type": "Page",    "link_to": "alphax-pos-setup"},
        ],
    },
    {
    ...
    },
    {
        ...
        "icon":  "chart",
        "links": [
            {"label": "Profitability Dashboard",    "link_type": "Page",    "link_to": "alphax-pos-profitability"},
